     ...
     <table border = "1">
      <tr>
       ...
       <?php
            ...
            $sql = "select pedido.numero, pedido.codvendedor, pedido.data, pedido.total, 
                    pedido.codcliente, vendedor.nome as nomevendedor, cliente.nome as nomecliente
                    from pedido join vendedor on pedido.codvendedor = vendedor.codigo 
